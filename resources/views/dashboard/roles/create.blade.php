                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name='name' class="form-control" id="exampleInputEmail1" placeholder="Enter a role name">
                      </div>
                      <div class="form-group" >
                        ...
                        @foreach ( $permission->all() as $permission )
                          <div style="display: inline-block;margin-bottom:10px">
                           <input style="margin-right: 10px" class="permission-checkbox" type="checkbox" value="{{ $permission->id }}" name="permissions[]">
