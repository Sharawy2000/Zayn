                    ...
                    <form action="{{ route('products.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" name='name' class="form-control" id="exampleInputEmail1" placeholder="Enter a product name">
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <input type="number" name='price' class="form-control" id="exampleInputEmail1" placeholder="Enter a product price" min="1">
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <button type="button" class="btn btn-secondary" id="add-color" style="margin-bottom: 20px">Add Color</button>
                          ...
                          <div class="form-group">
                            ...
                            <button type="button" class="btn btn-secondary" id="add-size" style="margin-bottom: 20px">Add Size</button>
