    ...
    <div class="container">
        <div class="flex-w flex-tr">
            <div class="size-210 bor10 p-lr-70 p-t-55 p-b-70 p-lr-15-lg w-full-md">
                ...
                <form action="{{ route('add-ContactMsg') }}" method="post">
                    @csrf
                    ...
                    <div class="bor8 m-b-20 how-pos4-parent">
                        ...
                        <img class="how-pos4 pointer-none" src="{{ asset('web-app/images/icons/icon-email.png') }}" alt="ICON">
                    </div>
                ...
                <div class="flex-w w-full p-b-42">
                    ...
                    <div class="size-212 p-t-2">
                        ...
                        <p class="stext-115 cl6 size-213 p-t-18">
                            Zain Store El souror square, Center Damietta, Damietta, Egypt
                        </p>
                    </div>
                </div>
