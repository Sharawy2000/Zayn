...
@inject('slide','App\Models\HomeSlide' )
@section('title')
 	Home 
@endsection
@section('body')
	...
	<section class="section-slide">
		<div class="wrap-slick1">
			<div class="slick1">
				@foreach ( $slide::orderBy('order','asc')->get() as $slide )
				...
				{{-- <div class="item-slick1" style="background-image: url({{ asset('web-app/images/slide-02.jpg') }});">
					<div class="container h-full">
						<div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
				...
				<div class="item-slick1" style="background-image: url({{ asset('web-app/images/slide-03.jpg') }});">
					<div class="container h-full">
						<div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
			...
			<div class="row">
				...
				<div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
					...
					<div class="block1 wrap-pic-w">
						<img src="{{ url($cat->image) }}" width="650" height="250" alt="IMG-BANNER">
		...
		<div class="container">
			...
			<div class="flex-w flex-sb-m p-b-52">
				<div class="flex-w flex-l-m filter-tope-group m-tb-10">
					...
					@foreach ($category->latest()->get() as $cat )
					<button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5" data-filter=".{{StrtoLower($cat->name)}}">
						{{ $cat->name }}
					</button>
					@endforeach
				</div>
					...
					<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item {{ StrtoLower($product->category->name) }}">
						...
						<div class="block2">
							<div class="block2-pic hov-img0">
								<img src="{{ $product->images->first()?->url }}" width="300" height="335" alt="IMG-PRODUCT">

								{{-- <a href="{{ route('show-product',$product->id) }}" class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04 js-show-modal{{ $product->id }}">
									Quick View
								</a> --}}
